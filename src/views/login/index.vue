<template>
	<div class="login-page">
		<div class="login-header">
			<div class="header-box">
				<div class="header-box-inner">
					<img style="width: 60px; height: 60px;" src="../../assets/imgs/MAFF.png" alt="">
				</div>
			...
			<div class="header-box">
				<div class="header-box-inner">
					<img style="width: 60px; height: 60px;" src="../../assets/imgs/FAO.png" alt="">
				</div>
				<div class="header-box-footer">
					FAO
				</div>
			...
			<div class="header-box">
				<div class="header-box-inner">
					<img style="width: 148px; height: 40px;" src="../../assets/imgs/OCOP.png" alt="">
				</div>
				<div class="header-box-footer">
					OCOP
				</div>
			...
			<div class="header-box">
				<div class="header-box-inner">
					<img style="width: 60px; height: 60px;" src="../../assets/imgs/logo.png" alt="">
				</div>
				<div class="header-box-footer">
					GEIS
				</div>
		...
		<div class="login-title">
			...
			<div class="login-title-left-bg" style="transform: scaleX(-1);"></div>
		</div>
		<div class="login-footer">
			<div class="login-footer-bg">
				<div class="login-footer-line-layer">
					<span v-for="(dot, index) in footerDots" :key="index" class="footer-dot"
						...
						<a-form v-model:values="formState">
							<a-form-item field="username">
								<a-input style="height: 48px; background-color: #f6f7fb;"
									v-model:value="formState.username" placeholder="Username or email"
									@pressEnter="handleLogin"></a-input>
							</a-form-item>
							<a-form-item field="password">
								<a-input style="height: 48px; background-color: #f6f7fb;"
									v-model:value="formState.password" :type="showPassword ? 'text' : 'password'"
									placeholder="Password" @pressEnter="handleLogin">
									<template #suffix>
										<img class="password-toggle-icon"
											:src="showPassword ? displayIcon : concealIcon"
											alt="toggle password visibility" @click.stop="togglePasswordVisible">
									</template>
								</a-input>
							</a-form-item>
							<a-form-item field="verificationCode">
								<div style="display:flex; align-items: center;">
									<a-input style="width: 228px; height: 48px; background-color: #f6f7fb;"
										v-model:value="formState.verificationCode" placeholder="Verification code"
										@pressEnter="handleLogin"></a-input>
									<ReImageVerify
							...
							<a-form-item>
								<a-checkbox class="login-box-checkbox" v-model:checked="formState.remember">
									Remember me
								</a-checkbox>
							</a-form-item>
							<a-form-item>
								<a-button class="login-box-submit" type="primary" :loading="loginLoading"
									@click="handleLogin">
									Login
								</a-button>
							</a-form-item>
							<a-form-item>
								<div class="login-box-agreement">
									...
									<div>
										I agree to the <a class="agreement-link" href="">Terms & Privacy Policy</a>
									</div>
								</div>
							</a-form-item>
						</a-form>
...
import { login, normalizeAuthToken } from '@/api/auth'
...
const handleLogin = async () => {
	...
	try {
		...
		const { accessToken, refreshToken, expires } = normalizeAuthToken(loginResp)
		if (!accessToken) {
